...
import '../data_sources/random_activity_local_data_source.dart';
import '../data_sources/random_activity_remote_data_source.dart';
...
class RandomActivityRepositoryImpl implements RandomActivityRepository {
  ...
  @override
  Future<Either<Failure, RandomActivity?>> getRandomActivity() async {  // imamo odgovor ili levo (error) ili desno (validan podatak)
